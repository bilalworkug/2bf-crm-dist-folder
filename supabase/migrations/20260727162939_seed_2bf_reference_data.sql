...
## Overview
Seeds reference data for the 2BF system:
- 8 roles
- 3 warehouses
- 13 real 2BF products
- 1 company settings row

## Notes
- Uses ON CONFLICT to be idempotent.
- Does NOT create auth.users (those are created via Supabase Auth from the app's sign-up flow or admin user management). Profiles rows are inserted by the app after sign-up.
*/
