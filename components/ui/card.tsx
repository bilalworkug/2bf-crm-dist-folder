...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-lg border border-border/80 bg-card text-card-foreground shadow-xs transition-shadow',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex flex-col space-y-1 p-4 sm:p-5 pb-3', className)}
    {...props}
  />
));
